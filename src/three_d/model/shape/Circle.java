...
public class Circle extends Shape{
    ...
    private void drawPoints(int x, int y) {
        PixelPoint pixelPoint1 = new PixelPoint(new Coordinate(central.getX() + x,central.getY() + y).userToMachineCoor(),Color.BLACK);
        super.putPixel(frame, pixelPoint1);
        super.coordinateHashMap.put(pixelPoint1.getCoordinate().toString(),pixelPoint1);
        PixelPoint pixelPoint2 = new PixelPoint(new Coordinate(central.getX() - x,central.getY() + y).userToMachineCoor(),Color.BLACK);
        super.putPixel(frame, pixelPoint2);
        super.coordinateHashMap.put(pixelPoint2.getCoordinate().toString(),pixelPoint2);
        PixelPoint pixelPoint3 = new PixelPoint(new Coordinate(central.getX() + x, central.getY() - y).userToMachineCoor(),Color.BLACK);
        super.putPixel(frame, pixelPoint3);
        super.coordinateHashMap.put(pixelPoint3.getCoordinate().toString(),pixelPoint3);
        PixelPoint pixelPoint4 = new PixelPoint(new Coordinate(central.getX() - x, central.getY() - y).userToMachineCoor(),Color.BLACK);
        super.putPixel(frame, pixelPoint4);
        super.coordinateHashMap.put(pixelPoint4.getCoordinate().toString(),pixelPoint4);
        PixelPoint pixelPoint5 = new PixelPoint(new Coordinate(central.getX() + y, central.getY() + x).userToMachineCoor(),Color.BLACK);
        super.putPixel(frame, pixelPoint5);
        super.coordinateHashMap.put(pixelPoint5.getCoordinate().toString(),pixelPoint5);
        PixelPoint pixelPoint6 = new PixelPoint(new Coordinate(central.getX() - y, central.getY() + x).userToMachineCoor(),Color.BLACK);
        super.putPixel(frame, pixelPoint6);
        super.coordinateHashMap.put(pixelPoint6.getCoordinate().toString(),pixelPoint6);
        PixelPoint pixelPoint7 = new PixelPoint(new Coordinate(central.getX() + y, central.getY() - x).userToMachineCoor(),Color.BLACK);
        super.putPixel(frame, pixelPoint7);
        super.coordinateHashMap.put(pixelPoint7.getCoordinate().toString(),pixelPoint7);
        PixelPoint pixelPoint8 = new PixelPoint(new Coordinate(central.getX() + -y,central.getY() + -x).userToMachineCoor(),Color.BLACK);
